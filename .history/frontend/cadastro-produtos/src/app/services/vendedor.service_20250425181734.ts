...
export class VendedorService {
  ...
  salvarVendedor(vendedor: any) {
    ...
    return this.http.post<any>(`${this.apiUrl.replace('/vendedores', '')}/vendedores/gravar-vendedor`, vendedor);
  }
...
Se o seu backend espera a URL `api/vendedores/gravar-vendedor`, então você precisa modificar o método para usar essa URL específica:
