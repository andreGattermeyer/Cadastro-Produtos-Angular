...
public class VendaController {
    ...
    public ResponseEntity<Venda> atualizarVenda(@RequestParam Long id, @RequestBody Venda vendaAtualizada) {
        try {
            Venda produtoAtualizado = produtoService.atualizarProduto(id, produto);
