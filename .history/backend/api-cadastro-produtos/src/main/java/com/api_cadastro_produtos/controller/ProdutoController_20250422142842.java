...
public class ProdutoController {
    ...
    @GetMapping("/lucro")
    public ResponseEntity<String> calcularLucro(
            @RequestParam(required = false, defaultValue = "0") BigDecimal precoCusto, 
            @RequestParam(required = false, defaultValue = "0") BigDecimal precoVenda) {
