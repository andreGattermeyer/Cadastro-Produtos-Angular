...
public class ProdutoController {
    ...
    public ResponseEntity<Iterable<Produto>> listarProdutos(@RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {
        Iterable<Produto> produtos = produtoService.listarProdutos(page, size);
